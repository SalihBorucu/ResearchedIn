    ...
    if (!e.jQuery) {
        ...
        ($.fn = $.prototype = {
            ...
            position: function() {
                function e() {
                    for (
                        var e = this.offsetParent || document; e &&
            ...
            return function a(e, t, n) {
                ...
                for (
                    ...
                    if (
                        ((f = r(f || o, p)),
                            i.push(1 + f.x),
                            (s += 16), !(Math.abs(f.x) > l && Math.abs(f.v) > l))
                    )
                        break;
                return c ?
                    ...
                    function d() {
                        ...
                        if (o && a)
                            ...
                            v.init(u),
                                ...
                                (l.emToPx = N.lastEmToPx =
                                    (parseFloat(
                                        x.getPropertyValue(u, "paddingLeft")
                                    ) || 1) / s),
...
!(function(a, b, c, d) {
    ...
    function B(a, b) {
        for (
            var c, f, g = b[0].toUpperCase() + b.slice(1), h = 0; h < e.length;
    ...
    (Yb.prototype = {
        ...
        requireFailure: function(a) {
            ...
            return (
                (a = _b(a, this)), -1 === y(b, a) && (b.push(a), a.requireFailure(this)),
                this
            );
        },
    ...
    p(ac, Yb, {
        ...
        p(dc, Yb, {
            ...
            process: function(a) {
                ...
                if (
                    ((this._input = a), !d || !c || (a.eventType & (Q | R) && !e))
                )
                    this.reset();
